...
foot.appendChild(footDiv);
footDiv = document.createElement('div');
footDiv.innerHTML = '<p style="font-size: 18px; padding: 0; margin: 5px auto 3px auto">&copy;RS Football Club 2022</p><p style="font-size: 13px; padding: 0; margin: 2px auto">Player images are property of EA Sports</p>';
foot.appendChild(footDiv);
